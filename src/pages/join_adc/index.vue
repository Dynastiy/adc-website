<template>
  <div>
    ...
    <div class="content">
      ...
      <p class="font-weight-bold text-main larger-text w-75 mb-5"> 
     ...
     <div class="reg__cards">
        ...
        <router-link to="reg_form"
          ><button
            class="bg-orange mt-3 w-100 btn font-weight-bold text-white small-btn-text"
          >
            Choose
          </button></router-link
        >
      ...
      <div>
        <button
          class="bg-main w-100 btn font-weight-bold text-white small-btn-text"
        >
