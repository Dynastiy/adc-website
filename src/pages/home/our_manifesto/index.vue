  ...
  <div>
    <div class="header">
      ...
      <div class="content container">
        <h2 class="font-weight-bold headerss text-white text-center pb-5">
          Our Manifesto
        </h2>
      </div>
    </div>
    ...
    <div class="Adc_objectives bg-darker">
      <div class="content container">
        <h1 class="font-weight-bold text-white text-center mb-5">
          ADC Objectives
        </h1>
        ...
        <div class="sub_Adc_objectives">
          ...
          <div class="objective_one_to_ten">
            ...
            <p>
              ...
              state policy, as contained in the Constitution of the Federal
              Republic of Nigeria, as well as conform at all times with the
    ...
    <div class="Co-operation_And_Partnerships">
      <div class="content Co-operation_And_Partnerships_grid container">
        <div class="Co-operate_with_Africans bg-orange text-center shadow">
          <ion-icon name="star"></ion-icon>
          <p class="mt-3">
            Co-operate with Africans and other Nationalist movements and
            organizations working for the eradication of imperialism,
            neo-colonialism, racism and to strive relentlessly towards African
            Unity, as well as greater understanding and cohesion amongall
        ...
        <div class="Co-operate_with_member_nations bg-main text-center shadow">
          <ion-icon name="star"></ion-icon>
          <p class="mt-3">
            Co-operate with all member nations in promoting the course of
            Economic Community of West African States (ECOWAS) the Organization
            of African Unity (OAU), The Common-wealth, and United Nations
            Organization (UNO) and other International and regional groupings
            that shall be in the best interest of Nigeria and Africa; and help
            to find just and peaceful solutions for international disputes.
          </p>
        </div>
        ...
        <div class="Build_socio-political_culture bg-darker text-center shadow">
          <ion-icon name="star"></ion-icon>
          <p class="mt-3">
            Build a new socio-political culture in which all Nigerians are equal
            members, where each contributes according to his ability and
            resource, where no one person dominates and where no political party
    ...
    <div class="cardinal_commitments">
      <div class="content row">
        <div class="col-md-6 mr-auto">
          <h5
            class="font-weight-bold text-white animate__animated animate__backInUp"
          >
    ...
    <div class="content container">
      ...
      <div class="aims_of_party container">
        <h2 class="larger-text font-weight-bold text-center text-darker my-4">
          Aims of the Party
        </h2>
        ...
        <div class="sub_aims_of_party d-flex justify-content-around">
          ...
          <div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To adhere to the rule of law, and promote justice and <br />
                equity.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To promote the To run good governance and practice <br />
                equitable, fair and transparent management of the <br />
                country's resources of Nigeria.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To promote the respect for the fundamental human <br />
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To provide full and productive employment for the <br />
                people
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To provide the environment of self respect, self-reliance
                <br />
                and human dignity for the populace.
              </p>
            </div>
          ...
          <div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To make democracy work for the people and, by so doing, <br />
                enhance the progress and well being of the people.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To promote free, fair and credible elections and abhor <br />
                imposition and impunity in the process of candidate selection.
              </p>
              <p></p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To maintain integrity and transparency in public affairs
                <br />
                management.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To ensure the security of all lives, families and properties.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To provide the environment of self respect, self-reliance and
                <br />
                human dignity for the populace.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To create a Nigerian society in which the basic things of life
                are <br />
                not taken for granted, including pipe borne water, electricity,
                <br />
                good roads, decent housing, and routine public services.
              </p>
            </div>
            ...
            <div class="aim_one_to_sixteen d-flex">
              ...
              ></i>
              <p>
                To encourage women and youth participation in national <br />
                development and make persons living with disabilities <br />
